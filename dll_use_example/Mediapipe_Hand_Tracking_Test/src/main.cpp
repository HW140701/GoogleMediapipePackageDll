...
int main()
{
	...
	//std::string test_video_path = "E:\\Programing\\C++_Project\\Mediapipe_Hand_Tracking\\Mediapipe_Hand_Tracking_Test\\bin\\Mediapipe_Hand_Tracking_Test\\x64\\Debug\\pjd-0028-Ch.mp4";
